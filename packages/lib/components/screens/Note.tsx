...
const { fileExtension, safeFileExtension } = require('../../path-utils');
...
const shared = require('../shared/note-screen-shared.js');
...
const ShareExtension = require('../../ShareExtension.js').default;
