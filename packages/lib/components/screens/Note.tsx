...
import UndoRedoService from 'inner/lib/services/UndoRedoService';
import uuid from 'inner/lib/uuid';
import Setting from 'inner/lib/models/Setting';
import shim from 'inner/lib/shim';
import NoteBodyViewer from 'inner/lib/components/NoteBodyViewer/NoteBodyViewer';
import checkPermissions from 'inner/lib/checkPermissions';
...
const { fileExtension, safeFileExtension } = require('inner/lib/path-utils');
const mimeUtils = require('inner/lib/mime-utils.js').mime;
const { ScreenHeader } = require('inner/lib/components/screen-header.js');
const NoteTagsDialog = require('inner/lib/components/screens/NoteTagsDialog');
...
const { themeStyle, editorFont } = require('inner/lib/components/global-style.js');
const { dialogs } = require('inner/lib/dialogs.js');
const DialogBox = require('react-native-dialogbox').default;
const DocumentPicker = require('react-native-document-picker').default;
const ImageResizer = require('react-native-image-resizer').default;
const shared = require('inner/lib/components/shared/note-screen-shared.js');
const ImagePicker = require('react-native-image-picker').default;
const SelectDateTimeDialog = require('inner/lib/components/SelectDateTimeDialog').default;
const ShareExtension = require('inner/lib/ShareExtension.js').default;
const CameraView = require('inner/lib/components/CameraView').default;
